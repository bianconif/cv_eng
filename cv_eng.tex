...
\subsection*{As member of the organising committee, track organiser or other leading roles}

\begin{itemize} 

	\item The 6$^\text{th}$ International Conference on Control, Automation and Diagnosis; Paris, France. Role: co-publication chair \hfill 2022

	\item The 5$^\text{th}$ International Conference on Control, Automation and Diagnosis; Paris, France. Role: co-publication chair \hfill 2021

	\item \emph{Texture Analysis, Classification and Retrieval (TAILOR)}, in conjunction with the 25$^\text{th}$ Int. Conf. on Pattern Recognition (ICPR), Milan, Italy. Role: workshop organiser \hfill 2020

	\item The 10$^\text{th}$ KES International Conference on Intelligent Interactive Multimedia: Systems and Services; Vilamoura, Portugal. Role: session organizer and chair (\emph{Processing visual data in intelligent systems: methods and applications}) \hfill 2017

\end{itemize}	

\subsection{As member of the TPC/IPC}
