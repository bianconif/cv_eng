...
\begin{itemize}	
	\item \emph{Technical Drawing} (5 CFU\footnote{Stands for \emph{Credito Formativo Universitario}. This is the unit used in the Italian higher education system to measure and assess the student's work and effort. The minimum number of required credits is 180 for a Bachelor's and 120 for a Master's degree.}) + \emph{Computer skills} (2 CFU), Università degli Studi di Perugia, Department of Engineering, BEng Industrial Engineering \mbox{} \hfill 2005--present
...
\begin{itemize}
		\item Member of the final evaluation committee for the degree of Doctor of Philosophy, International Doctoral School, Universidade de Vigo, Spain \hfill February 2023
