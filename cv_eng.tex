...
\begin{itemize}
	\item \emph{Caratteristiche di forma, colore e tessitura per l’analisi di immagini
piane e volumetriche: metodi ed applicazioni } (\emph{Shape, colour and texture features for the analysis of two- and three-dimensional images: methods and applications}). Fundamental research grants, Department of Engineering, Università degli Studi di Perugia, Italy. Amount granted: € 2.751,32. \hfill 2020-2021
\end{itemize}
